...
server <- function(input,output){
  ...
  genoHead <- eventReactive(input$infileVCF,{ paste("Genotype Table with ",nrow(Geno())," lines and ",ncol((Geno()))," markers",sep="")})
